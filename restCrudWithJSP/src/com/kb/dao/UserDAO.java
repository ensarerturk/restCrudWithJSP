/*
 * DAO sýnýfýný oluþturduk.
 * Kullanýcý ayrýntýlarýný depolamak için bir usersMap kullandýk (sadece DB etkileþimini önlemek için)
 * diðer tüm yöntemler, kullanýcý ayrýntýlarýný okumak, eklemek, güncellemek ve silmek için bu userMap'i kullanýr.
 * */
